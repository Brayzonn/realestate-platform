...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const baseStyles = 'inline-flex items-center justify-center font-medium rounded-[0px] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2';
