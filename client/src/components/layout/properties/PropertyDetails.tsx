...
const PropertyDetails = () => {
  ...
  const sendCustomerInquiry = () => {
    if (property) {
      sessionStorage.setItem('selectedProperty', JSON.stringify(property));
    }
    return navigate(`/properties/${property.id}/inquiry`);
  };
    ...
    <section className="flex w-full flex-col space-y-16">
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
        <div className="order-1">
          <div className="aspect-[4/3] h-full w-full overflow-hidden rounded-sm border border-gray-200/60 shadow-sm">
            <img
        ...
        <div className="order-1 md:order-2">
          <div className="w-full rounded-sm border border-gray-200/60 bg-white p-8 shadow-sm">
